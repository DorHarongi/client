...
import { cropFarmUpgradeMaterialCostByLevels, factoriesProductionSpeedByLevel, singleWorkerProductionSpeedPerSecond, getEffectiveProductionMultiplier } from 'utils';
...
export class CropFarmComponent implements OnInit, OnDestroy {
  ...
  canHire(): boolean {
    return this.cropWorkers !== this.userInformationService.currentVillage.resourcesWorkers.cropWorkers;
  }
