...
import {
  WALL_DETECTION_PER_LEVEL,
  wallDefenseByLevel,
  wallUpgradeMaterialCostByLevels,
} from 'utils';
...
export class WallComponent implements OnInit {
  ...
  constructor(private userInformationService: UserInformationService) {
    this.wallLevel =
      this.userInformationService.currentVillage.buildingsLevels.wallLevel;
    ...
    this.nextLevelDetectionBonus =
      (this.wallLevel + 1) * WALL_DETECTION_PER_LEVEL;
  }
